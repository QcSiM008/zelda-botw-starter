export default {
  weapons: [
    ...
    },
    {
      ...
      category: 'weapon',
      icon: process.env.PUBLIC_URL + 'items/weapons/BotW_Ancient_Short_Sword_Icon.png',
      value: '40',
      description:
    ...
    },
    {
      ...
      category: 'weapon',
      icon: process.env.PUBLIC_URL + 'items/weapons/BotW_Dragonbone_Boko_Club_Icon.png',
      value: '24',
      isNew: true,
      description:
    ...
    },
    {
      name: 'Feathered Edge',
      category: 'weapon',
      icon: process.env.PUBLIC_URL + 'items/weapons/BotW_Feathered_Edge_Icon.png',
      value: '15',
      description:
    ...
    },
    {
      ...
      category: 'weapon',
      isNew: true,
      icon: process.env.PUBLIC_URL + "items/weapons/BotW_Soldier's_Broadsword_Icon.png",
      value: '14',
      description:
    ...
    },
    {
      name: 'Royal Claymore',
      category: 'weapon',
      icon: process.env.PUBLIC_URL + 'items/weapons/BotW_Royal_Claymore_Icon.png',
      value: '52',
      description:
  ...
  shields: [
    {
      name: 'Wooden Shield',
      category: 'shield',
      icon: process.env.PUBLIC_URL + 'items/shields/BotW_Wooden_Shield_Icon.png',
      value: '2',
      description:
    ...
    },
    {
      ...
      category: 'shield',
      icon: process.env.PUBLIC_URL + "items/shields/BotW_Traveler's_Shield_Icon.png",
      value: '4',
      description:
    ...
    },
    {
      ...
      category: 'shield',
      isNew: true,
      icon: process.env.PUBLIC_URL + 'items/shields/BotW_Gerudo_Shield_Icon.png',
      value: '20',
      description:
    ...
    },
    {
      ...
      category: 'shield',
      icon: process.env.PUBLIC_URL + 'items/shields/BotW_Ancient_Shield_Icon.png',
      value: '70',
      description:
  ...
  armors: [
    ...
    },
    {
      ...
      category: 'helm',
      icon: process.env.PUBLIC_URL + "items/armors/BotW_Climber's_Bandanna_Icon.png",
      value: '3',
      bonus: 'climbing',
      description:
    ...
    },
    {
      name: 'Climbing Boots',
      category: 'greave',
      icon: process.env.PUBLIC_URL + 'items/armors/BotW_Climbing_Boots_Icon.png',
      value: '3',
      bonus: 'climbing',
      description:
    ...
    },
    {
      ...
      category: 'helm',
      icon: process.env.PUBLIC_URL + 'items/armors/BotW_Flamebreaker_Helm_Icon.png',
      value: '3',
      bonus: 'fire',
      description:
    ...
    },
    {
      ...
      category: 'armor',
      icon: process.env.PUBLIC_URL + 'items/armors/BotW_Flamebreaker_Armor_Icon.png',
      value: '3',
      bonus: 'fire',
      description:
    ...
    },
    {
      ...
      category: 'greave',
      icon: process.env.PUBLIC_URL + 'items/armors/BotW_Flamebreaker_Boots_Icon.png',
      value: '3',
      bonus: 'fire',
      description:
    ...
    },
    {
      ...
      category: 'helm',
      icon: process.env.PUBLIC_URL + 'items/armors/BotW_Cap_of_the_Hero_Icon.png',
      value: '3',
      bonus: 'normal',
      description:
    ...
    },
    {
      ...
      category: 'armor',
      isNew: true,
      icon: process.env.PUBLIC_URL + "items/armors/BotW_Champion's_Tunic_Icon.png",
      value: '5',
      bonus: 'normal',
      description:
    ...
    },
    {
      ...
      category: 'greave',
      isNew: true,
      icon: process.env.PUBLIC_URL + 'items/armors/BotW_Hylian_Trousers_Icon.png',
      value: '3',
      bonus: 'normal',
      description:
